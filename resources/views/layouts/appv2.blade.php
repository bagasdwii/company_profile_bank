                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                                <a href="#" class="nav-link {{ Request::is('data_kontak','data_laporan','data_karir','data_kantor_cabang','data_edukasi','data_ppob','data_kredit','data_deposito','data_profile','data_slider', 'data_produk', 'data_berita', 'data_penghargaan', 'data_tabungan') ? 'active' : '' }}">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="/data_ppob" class="nav-link {{ Request::is('data_ppob') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Data PPOB</p>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="/data_kantor_cabang" class="nav-link {{ Request::is('data_kantor_cabang') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Data Kantor Cabang</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/data_karir" class="nav-link {{ Request::is('data_karir') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Data Karir</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/data_laporan" class="nav-link {{ Request::is('data_laporan') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Data Laporan</p>
                                        </a>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a href="/data_kontak" class="nav-link {{ Request::is('data_kontak') ? 'active' : '' }}">
