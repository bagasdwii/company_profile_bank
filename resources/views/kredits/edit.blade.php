            ...
            <div class="col-md-12">
                <form  action="{{ route('data_kredit.update', $dataKredit->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <form-group>
                        ...
                        <input type="text" id="nomor_button" class="form-control" name="nomor_button" placeholder="Nomor Button"  value="{{ $dataKredit->nomor_button }}">
                    </form-group>
                    <img class="img-fluid rounded mx-auto d-block my-3" src="/assets/data_kredit/{{ $dataKredit->gambar }}" alt="">
                    <form-group>
