            ...
            <div class="col-md-12">
                <form  action="{{ route('data_deposito.update', $dataDeposito->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <form-group>
                        ...
                        <input type="text" id="nomor_button" class="form-control" name="nomor_button" placeholder="Nomor Button"  value="{{ $dataDeposito->nomor_button }}">
                    </form-group>
                    <img class="img-fluid rounded mx-auto d-block my-3" src="/assets/data_deposito/{{ $dataDeposito->gambar }}" alt="">
                    <form-group>
