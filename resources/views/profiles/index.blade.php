            ...
            <table class="table table-bordered border-light table-hover table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img class="img-fluid rounded mx-auto d-block" src="{{ Storage::url($profile->gambar) }}" alt="" style="max-width: 90px;" data-bs-toggle="modal" data-bs-target="#modalGambar{{ $profile->id }}">
                        </td>
                        <td>
                            <div class="d-flex">
                                <a href="{{ route('data_profile.show', $profile->id) }}" class="btn btn-info btn-sm me-2">
                    ...
                    <div class="modal fade" id="modalGambar{{ $profile->id }}" tabindex="-1" aria-labelledby="modalGambarLabel{{ $profile->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-xl modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img class="img-fluid" src="{{ Storage::url($profile->gambar) }}" alt="Gambar profile">
                                </div>
                            </div>
                        </div>
                    </div>
