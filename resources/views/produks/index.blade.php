            ...
            <table class="table table-bordered border-light table-hover table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img class="img-fluid rounded mx-auto d-block bg-image hover-zoom" src="assets/data_produk/{{ $produk->gambar }}" alt="" style="max-width: 90px;" data-bs-toggle="modal" data-bs-target="#modalGambar{{ $produk->id }}">
                        </td>
                        <td>
                            <div class="d-flex">
                    ...
                    <div class="modal fade" id="modalGambar{{ $produk->id }}" tabindex="-1" aria-labelledby="modalGambarLabel{{ $produk->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-xl modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img class="img-fluid" src="assets/data_produk/{{ $produk->gambar }}" alt="Gambar Produk">
                                </div>
                            </div>
                        </div>
                    </div>
