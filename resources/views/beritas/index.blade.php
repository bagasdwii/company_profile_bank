            ...
            <table class="table table-bordered border-light table-hover table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img class="img-fluid rounded mx-auto d-block" src="{{ Storage::url($berita->gambar) }}" alt="" style="max-width: 90px;" data-bs-toggle="modal" data-bs-target="#modalGambar{{ $berita->id }}">
                        </td>
                        <td>
                            <div class="d-flex">
                    ...
                    <div class="modal fade" id="modalGambar{{ $berita->id }}" tabindex="-1" aria-labelledby="modalGambarLabel{{ $berita->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-xl modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img class="img-fluid" src="{{ Storage::url($berita->gambar) }}" alt="Gambar berita">
                                </div>
                            </div>
                        </div>
                    </div>
